 ...
 * </ul>
 */
public class WindowSessionWordCount21 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<String> outST = waterSensorDs
                ...
                .process(new ProcessWindowFunction<WaterSensor, String, String, TimeWindow>() {
                    ...
                    public void process(
                        ...
                        String window = "window range:【" + context.window().getStart()+"," + context.window().getEnd() + "】 ";
                        sb.append(window);
                        for(WaterSensor e: elements){
                            sb.append(" ("+e.getId()+"," + e.getVc() + "," + e.getTs() + ") ");
                        }
