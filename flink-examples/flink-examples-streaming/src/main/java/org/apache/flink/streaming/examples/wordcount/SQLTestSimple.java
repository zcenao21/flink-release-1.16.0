...
//        StreamTableEnvironment tEnv = StreamTableEnvironment.create(env);
        ...
        TableResult tableRes = tEnv.executeSql("SELECT word,sum(frequency) as frequency FROM WordCount where CHAR_LENGTH(word)>1 group by word");
